...
featuresToCompute = {'feature_Peak', 'feature_WavePC1'};%{'feature_Energy', 'feature_EnergyD1', 'feature_Peak', 'feature_WavePC1', 'feature_Time'};
featuresToUse = {'feature_Peak', 'feature_WavePC1'};
